...
namespace webRGE.Entities.Dictionary
{
	public class TSI00207
	{
		...
		/// <summary>
		///Код справочника "Должности работников"- TSI00207(S_dolgn)
		/// </summary>
		...
		/// <summary>
		///Ключ справочника "Должности работников"- TSI00207(S_dolgn)
		/// </summary>
		...
		public string VNDOLGNK { get; set; }
