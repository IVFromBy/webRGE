...
namespace webRGE.Entities.Dictionary
{
	public class TSI00204
	{
		...
		/// <summary>
		///Код справочника(ОГК) "Валюты" - TSI00204(S_valuta)
		/// </summary>
		...
		/// <summary>
		///Ключ справочника(ОГК) "Валюты" - TSI00204(S_valuta)
		/// </summary>
		...
		/// <summary>
		///Наименование валюты (краткое)
		/// </summary>
		public string VNVALUTK { get; set; }
		/// <summary>
		///Наименование валюты (полное)
		/// </summary>
		public string VNVALUTP { get; set; }
	}
}